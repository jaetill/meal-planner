...
var EventBuffer_1 = tslib_1.__importDefault(require("./EventBuffer"));
...
var AWSPinpointProvider = /** @class */ (function () {
    ...
    AWSPinpointProvider.prototype._pinpointSendStopSession = function (params, handlers) {
        ...
        var requestUrl = core_1.Signer.signUrl(request, accessInfo, serviceInfo);
    ...
    AWSPinpointProvider.prototype._initBuffer = function () {
        ...
        this._buffer = new EventBuffer_1.default(this._config);
    ...
    AWSPinpointProvider.prototype._getEndpointId = function (cacheKey) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cache_1.Cache.getItem(cacheKey)];
                    case 1:
                        endpointId = _a.sent();
    ...
    AWSPinpointProvider.prototype._endpointRequest = function (config, event) {
        ...
        // for backward compatibility
        var clientId = clientContext.clientId, appTitle = clientContext.appTitle, appVersionName = clientContext.appVersionName, appVersionCode = clientContext.appVersionCode, appPackageName = clientContext.appPackageName, demographicByClientContext = tslib_1.__rest(clientContext, ["clientId", "appTitle", "appVersionName", "appVersionCode", "appPackageName"]);
        ...
        var tmp = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ channelType: channelType, requestId: uuid_1.v1(), effectiveDate: new Date().toISOString() }, defaultEndpointConfig), event), { attributes: tslib_1.__assign(tslib_1.__assign({}, defaultEndpointConfig.attributes), event.attributes), demographic: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, demographicByClientInfo), demographicByClientContext), defaultEndpointConfig.demographic), event.demographic), location: tslib_1.__assign(tslib_1.__assign({}, defaultEndpointConfig.location), event.location), metrics: tslib_1.__assign(tslib_1.__assign({}, defaultEndpointConfig.metrics), event.metrics), user: {
                ...
                userAttributes: tslib_1.__assign(tslib_1.__assign({}, defaultEndpointConfig.userAttributes), event.userAttributes),
            } });
        // eliminate unnecessary params
        var userId = tmp.userId, userAttributes = tmp.userAttributes, name = tmp.name, session = tmp.session, eventId = tmp.eventId, immediate = tmp.immediate, ret = tslib_1.__rest(tmp, ["userId", "userAttributes", "name", "session", "eventId", "immediate"]);
        return core_1.transferKeyToUpperCase(ret, [], ['metrics', 'userAttributes', 'attributes']);
    };
